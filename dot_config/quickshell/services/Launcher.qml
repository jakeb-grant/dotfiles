...
Singleton {
    ...
    readonly property var _keybinds: [
        ...
        { name: "Close Window", shortcut: "Super + W", command: "hyprctl dispatch 'hl.dsp.window.close()'", keywords: ["kill","quit"] },
        { name: "Toggle Floating", shortcut: "Super + T", command: "hyprctl dispatch 'hl.dsp.window.float({ action = \"toggle\" })'", keywords: ["tile","float"] },
        { name: "Fullscreen", shortcut: "Super + F", command: "hyprctl dispatch 'hl.dsp.window.fullscreen()'", keywords: ["maximize"] },
        { name: "Pin Window", shortcut: "Super + O", command: "hyprctl dispatch 'hl.dsp.window.pin()'", keywords: ["sticky"] },
        { name: "Swap Window Left", shortcut: "Super + Shift + Left", command: "hyprctl dispatch 'hl.dsp.window.swap({ direction = \"l\" })'", keywords: ["move","swap"] },
        { name: "Swap Window Right", shortcut: "Super + Shift + Right", command: "hyprctl dispatch 'hl.dsp.window.swap({ direction = \"r\" })'", keywords: ["move","swap"] },
        { name: "Swap Window Up", shortcut: "Super + Shift + Up", command: "hyprctl dispatch 'hl.dsp.window.swap({ direction = \"u\" })'", keywords: ["move","swap"] },
        { name: "Swap Window Down", shortcut: "Super + Shift + Down", command: "hyprctl dispatch 'hl.dsp.window.swap({ direction = \"d\" })'", keywords: ["move","swap"] },
        { name: "Resize Wider", shortcut: "Super + =", command: "hyprctl dispatch 'hl.dsp.window.resize({ x = 50, y = 0 })'", keywords: ["grow","resize"] },
        { name: "Resize Narrower", shortcut: "Super + -", command: "hyprctl dispatch 'hl.dsp.window.resize({ x = -50, y = 0 })'", keywords: ["shrink","resize"] },
        { name: "Resize Taller", shortcut: "Super + Shift + =", command: "hyprctl dispatch 'hl.dsp.window.resize({ x = 0, y = 50 })'", keywords: ["grow","resize"] },
        { name: "Resize Shorter", shortcut: "Super + Shift + -", command: "hyprctl dispatch 'hl.dsp.window.resize({ x = 0, y = -50 })'", keywords: ["shrink","resize"] },
        { name: "Next Workspace", shortcut: "Super + Tab", command: "hyprctl dispatch 'hl.dsp.focus({ workspace = \"e+1\" })'", keywords: ["switch"] },
        { name: "Previous Workspace", shortcut: "Super + Shift + Tab", command: "hyprctl dispatch 'hl.dsp.focus({ workspace = \"e-1\" })'", keywords: ["switch"] },
        { name: "Last Workspace", shortcut: "Super + Ctrl + Tab", command: "hyprctl dispatch 'hl.dsp.focus({ workspace = \"previous\" })'", keywords: ["switch","previous","back"] },
        { name: "Scratchpad", shortcut: "Super + S", command: "hyprctl dispatch 'hl.dsp.workspace.toggle_special(\"magic\")'", keywords: ["hidden","stash"] },
        { name: "Dismiss Notification", shortcut: "Super + ,", command: "hyprctl dispatch 'hl.dsp.global(\"quickshell:notif-dismiss\")'", keywords: ["close","clear"] },
        { name: "Dismiss All", shortcut: "Super + Shift + ,", command: "hyprctl dispatch 'hl.dsp.global(\"quickshell:notif-dismiss-all\")'", keywords: ["clear","close"] },
        { name: "Notification Panel", shortcut: "Super + Alt + ,", command: "hyprctl dispatch 'hl.dsp.global(\"quickshell:notif-panel\")'", keywords: ["center"] },
        ...
        { name: "Lock Screen", shortcut: "Super + L", command: "hyprctl dispatch 'hl.dsp.global(\"quickshell:lock\")'", keywords: ["lock"] },
        { name: "Toggle Bar Mode", shortcut: "Super + Shift + T", command: "toggle-bar-mode", keywords: ["sidebar","topbar","bar","layout","swap"] },
        { name: "Logout", shortcut: "", command: "hyprctl dispatch 'hl.dsp.exit()'", keywords: ["exit"] },
