...
### Generated `.tmpl` Files (gitignored)

Build artifacts generated by `theme-switch`. After a fresh clone, run `theme-switch <theme>` to regenerate them before `chezmoi apply`.
